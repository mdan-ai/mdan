...
const loginSourcePath = join(exampleRoot, "app", "login.md");
const registerSourcePath = join(exampleRoot, "app", "register.md");
const vaultSourcePath = join(exampleRoot, "app", "vault.md");
...
<script type="module">
  import { mountAuthSessionExample } from "${withVersion("/app/client.js")}";

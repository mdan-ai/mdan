...
description: Safely integrate the MDAN runtime into an existing backend framework.
---
...
- Want to see how to plug MDAN into an existing backend: [Server Integration](/docs/server-integration)

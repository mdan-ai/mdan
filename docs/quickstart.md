---
title: Quickstart
description: Create and run a TypeScript MDAN starter app, open it in a browser, and inspect the same interactive Markdown app or agent app surface as a Markdown response for agents.
---

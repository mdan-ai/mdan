---
title: MDAN
description: MDAN is a Markdown-first framework for building apps that humans and AI agents can both use.
---
...
`@mdanai/sdk` is the current reference implementation for this format and its host behavior.

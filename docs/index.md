---
title: MDAN SDK Docs
description: Developer documentation for the MDAN TypeScript SDK for building interactive Markdown plus JSON surfaces shared by humans and agents.
---

# MDAN SDK Docs

MDAN is a Markdown-first application surface model and TypeScript SDK for
building interactive Markdown plus JSON surfaces that work for both humans and
agents.

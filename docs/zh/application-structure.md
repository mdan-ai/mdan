---
title: 应用结构
description: 使用 MDAN 构建真实应用时推荐的目录结构、路由模型与 action 组织方式，尤其适合 agent app 和 skills app。
---

# 应用结构

这页讲的是：如果你要用 MDAN 搭一个真实应用，代码、页面和交互最好怎么摆，尤其是 agent app 和 skills app 这类场景。

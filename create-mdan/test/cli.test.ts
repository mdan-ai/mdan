...
describe("create-mdan cli messaging", () => {
  ...
  it("shows node next steps", () => {
    ...
    expect(lines).toContain("Created MDAN node starter in agent-app");
  ...
  it("shows bun next steps", () => {
    ...
    expect(lines).toContain("Created MDAN bun starter in agent-app");
